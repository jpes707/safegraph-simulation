...
lda = gensim.models.LdaModel(lda_corpus, num_topics=NUM_TOPICS, id2word=lda_dictionary, alpha='auto', eval_every=5)
print('Complete! Displaying visualization in web browser...')
cbgs_to_map([elem[0] for elem in lda.top_topics(lda_corpus)], ['topic_{}'.format(idx) for idx in range(NUM_TOPICS)])
